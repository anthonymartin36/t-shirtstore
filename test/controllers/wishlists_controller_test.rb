...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference("Wishlist.count") do
      post wishlists_url, params: { wishlist: { customer_id: @wishlist.customer_id, product_id: @wishlist.product_id, quantity: @wishlist.quantity } }, as: :json
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { customer_id: @wishlist.customer_id, product_id: @wishlist.product_id, quantity: @wishlist.quantity } }, as: :json
    assert_response :success
  end
